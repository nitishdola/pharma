...
@section('page_title') Dispatch Stock Report @stop
...
<div class="col-md-12">
	<div class="widget box">
		<div class="widget-content">
			...
			{!! Form::open(array('route' => 'stock_dispatch.report', 'id' => 'stock_dispatch.report', 'class' => 'form-horizontal row-border', 'method' => 'GET')) !!}
			<div class="row">
			...
			<a href="{{ route('stock_out.excel') }}" class="btn btn-info">Download Data as Excel</a>
			<div  style="margin:10px 0 20px 0"></div>
				...
				<table class="table table-striped table-bordered table-advance table-hover">
				    ...
				    @foreach($results as $k => $v)
				        <tr>
				            ...
				            <td> {{ $v->avat }} % </td>
				            <td> {{ $v->special_discount }} </td>
				            <td> <a href="{{ route('stock_dispatch.receipt', $v->id) }}" class="btn btn-info">View and Print</a> </td>
				        </tr>
				        @endforeach
				    </tbody>
				</table>
