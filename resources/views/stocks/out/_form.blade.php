<div class="col-md-12">
	...
	<div class="form-group {{ $errors->has('dispatch_date') ? 'has-error' : ''}}">
	  {!! Form::label('dispatch_date', 'Stock Receive Date', array('class' => 'col-md-2 control-label')) !!}
	  <div class="col-md-3">
	...
	<div class="form-group {{ $errors->has('avat') ? 'has-error' : ''}}">
	  ...
	  <div class="col-md-3">
	    {!! Form::number('special_discount ', null, ['class' => 'form-control col-md-6', 'id' => 'special_discount ', 'step' => '0.01',  'autocomplete' => 'off', 'placeholder' => 'Special Discount']) !!}
	  </div>
